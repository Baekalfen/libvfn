...
// ssize_t _pgmap(void **mem, size_t sz);
// ssize_t _pgmapn(void **mem, unsigned int n, size_t sz);
// void _pgunmap(void **mem, size_t len); // Double pointer
// ssize_t _pgmap(struct nvme_ctrl* ctrl, void **mem, size_t sz);
// ssize_t _pgmapn(struct nvme_ctrl* ctrl, void **mem, unsigned int n, size_t sz);
// void _pgunmap(struct nvme_ctrl* ctrl, void *mem, size_t len);
